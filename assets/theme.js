...
(function($){
  ...
  theme.predictiveSearch = (function() {
    ...
    var selectors = {
      form: '#HeaderSearchForm, #HeaderSearchForm-2',
  ...
  theme.Product = (function() {
    ...
    Product.prototype = $.extend({}, Product.prototype, {
      ...
      initVariants: function() {
        ...
        var $checked_el = $(this.selectors.variantColorSwatch + '[checked="checked"]');
        var checked_color = $checked_el.data('color-name');
        var checked_index = $checked_el.data('color-index');
        this.updateColorName(checked_color, checked_index);
  ...
  theme.Photoswipe = (function() {
    ...
    Photoswipe.prototype = $.extend({}, Photoswipe.prototype, {
      ...
      getImageData: function() {
        ...
        var options = {};
        let zoomLvl;
        window.innerWidth>767?zoomLvl = 0.2:zoomLvl =0.1
  ...
  /*---- Slider sections/featured-collection-slider.liquid -----*/
  $(function(){
    $('.featured-collection-slider .collection-slider-cont').each(function() {
      var _this = $(this);
      $(this).slick({
        slide: '.grid-product',
        dots: true,
        ...
        slidesToShow: 4,
        slidesToScroll: 2,
        appendArrows: $(_this).find('.slider--nav'),
        appendDots: $(_this).find('.slider--nav'),
        responsive: [
          {
            breakpoint: 1024,
            settings: {
  ...
  /*---- Slider sections/logo-list.liquid -----*/
  $(function(){
    $('.logo-list .logo-bar--cont').each(function() {
      var _this = $(this);
      $(this).slick({
        slide: '.logo-bar__item',
        dots: true,
        infinite: true,
        speed: 500,
        autoplay: true,
